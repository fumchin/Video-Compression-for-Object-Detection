...
#SBATCH --output=./log/eval_learned/test.%j.out     # 标准输出文件
...
echo "Start evaluating q6_test_stage2_e-6..."
touch ./voc_results/mse/q6_test_stage2_e-6_log.txt
python -m compressai.utils.eval_model checkpoint /home/englishassignment123/work/baseline/vcod/datasets/VOC/images/test2007 -a tinylic -p /home/englishassignment123/work/baseline/vcod/both_pretrained/checkpoints_q6_pretrained_2_e-6/checkpoint_compression_9.pth.tar --cuda --output-path ./voc_results/mse/q6_test_stage2_e-6/ > ./voc_results/mse/q6_test_stage2_e-6log.txt
