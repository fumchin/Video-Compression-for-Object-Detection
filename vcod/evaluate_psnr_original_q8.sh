...
echo "Start evaluating q8_original..."
touch ./voc_results/mse/q8_original_log.txt
python -m compressai.utils.eval_model checkpoint /home/englishassignment123/work/baseline/vcod/datasets/VOC/images/test2007 -a tinylic -p /home/englishassignment123/work/baseline/vcod/pretrain-weight/mse/checkpoint_q8.pth.tar --cuda --output-path ./voc_results/mse/q8_original/ > ./voc_results/mse/q8_original_log.txt
