...
echo "Start evaluating q6_val_original..."
touch ./voc_results/mse/q6_val_original_log.txt
python -m compressai.utils.eval_model checkpoint /home/englishassignment123/work/baseline/vcod/datasets/VOC/images/val2007 -a tinylic -p /home/englishassignment123/work/baseline/vcod/pretrain-weight/mse/checkpoint_q6.pth.tar --cuda --output-path ./voc_results/mse/q6_val_original/ > ./voc_results/mse/q6_val_original_log.txt
