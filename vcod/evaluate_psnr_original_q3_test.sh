...
echo "Start evaluating q3_stage2..."
touch ./voc_results/mse/q3_stage2_log.txt
python -m compressai.utils.eval_model checkpoint /home/englishassignment123/work/baseline/vcod/datasets/VOC/images/test2007 -a tinylic -p /home/englishassignment123/work/baseline/vcod/both_pretrained/checkpoints_q3_finetuned_dual/checkpoint_best_loss_compression.pth.tar --cuda --output-path ./voc_results/mse/q3_stage2/ > ./voc_results/mse/q3_stage2_log.txt
