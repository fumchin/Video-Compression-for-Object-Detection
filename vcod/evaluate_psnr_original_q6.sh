...
echo "Start evaluating q6_train_original..."
touch ./voc_results/mse/q6_train_original_log.txt
python -m compressai.utils.eval_model checkpoint /home/englishassignment123/work/baseline/vcod/datasets/VOC/images/train2007 -a tinylic -p /home/englishassignment123/work/baseline/vcod/pretrain-weight/mse/checkpoint_q6.pth.tar --cuda --output-path ./voc_results/mse/q6_train_original/ > ./voc_results/mse/q6_train_original_log.txt
