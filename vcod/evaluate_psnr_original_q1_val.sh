...
#SBATCH --output=./log/eval_learned/val.%j.out     # 标准输出文件
#SBATCH --error=./log/eval_learned/val.%j.err      # 错误输出文件
...
# python examples/val.py -m tinylic -d ../../../dataset/PASCAL/all --epochs 400 -lr 1e-4 --batch-size 4 --cuda --save
...
echo "Start evaluating q1_val_original..."
touch ./voc_results/mse/q1_val_original_log.txt
python -m compressai.utils.eval_model checkpoint /home/englishassignment123/work/baseline/vcod/datasets/VOC/images/val2007 -a tinylic -p /home/englishassignment123/work/baseline/vcod/pretrain-weight/mse/checkpoint_q1.pth.tar --cuda --output-path ./voc_results/mse/q1_val_original/ > ./voc_results/mse/q1_val_original_log.txt
